...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (empty($thumb['name'])) {//Usamos esta condicional por si queremos mantener la imagen guardada.
	...
	//Ya tenemos todo listo para subir los datos que acabamos de modificar a nuestra base de datos.
